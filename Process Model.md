...
## 37. What is the difference between escalation and exception?
...
## 38. What is the difference between User Input Task and Process Start Form? When should one use Process Start Form?
...
## 40. What is the purpose of lane assignments?
...
## 41. Why should we build short-lived processes?
...
## 42. What is the difference between asynchronous subprocess and Start Process?
...
## 44. What is the purpose of alerts in Process model?
...
## 45. Why do we need the data management? When should one select the delete option in data management?
...
## 48. What are the different types of process report?
Process models
Process instances
Active tasks

## 49. What is the function used to get the results from process report?
a!queryProcessAnalytics()

## 50. What is the purpose of activity chaining? What is the maximum limit?
...
## 51. When a process with an active task is paused, will the task be available to the user to perform?
No. An error will be shown to the user when the task is opened.

## 52. Will timer node execute when the instance is paused?
Yes

## 53. What is a MNI and its best practices?
...
## 54. What are Gateways and their purpose?
...
## 55. The triggers that can be added to a start event are:
Receive Message
Timer

## 56 . What is the difference between Task Assignee and Task Owner?
Task Assignees: The people for whom the task is being assigned.
Task Owner: The person who accepts a group task.

## 57. What should be the reassignment privilege for basic users?
...
## 58. Can the default task assignment mail be disabled?
Yes, under the assignment tab the option can be unchecked.

## 59. Scenario where record type over a tradition CDT Method?
